...
CREATE TABLE isup_param (
       ...
       send_app             tinyint DEFAULT 0 NOT NULL,
       isup_msgpar          tinyint DEFAULT 0 NOT NULL,
       interpret_locnr      tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE inap_param (
       ...
       start_invokeid       smallint DEFAULT 1 NOT NULL,
...
CREATE TABLE dp_property (
       ...
       dp_diversion         tinyint DEFAULT 0 NOT NULL,
       dp_set_add_param     tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE inap_cpb (
       ...
       idp_addit_cgpn       tinyint DEFAULT 1 NOT NULL,
       idp_fwci             tinyint DEFAULT 1 NOT NULL,
       pc_msg               tinyint DEFAULT 1 NOT NULL,
       sci_msg              tinyint DEFAULT 2 NOT NULL,
       sci_bcc              tinyint DEFAULT 1 NOT NULL,
       cirq_msg             tinyint DEFAULT 2 NOT NULL,
       cirp_msg             tinyint DEFAULT 2 NOT NULL,
       con_srvintind        tinyint DEFAULT 0 NOT NULL,
       ctr_srvintind        tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE otc_muted_participant (
       nodeid               integer NOT NULL,
       otc_dspt_circnr      char(2) NOT NULL,
       otc_mutedn           varchar(25) NOT NULL,
       PRIMARY KEY (nodeid, otc_dspt_circnr, otc_mutedn)
);
...
CREATE TABLE common_srv_setting (
       ...
       sip_passwd_policy    smallint DEFAULT 4 NOT NULL,
       PRIMARY KEY (nodeid)
);
...
CREATE TABLE inap_scp_param (
       ...
       rrbcsme_legid        tinyint DEFAULT 1 NOT NULL,
       rrbcsme_dpspeccrit   tinyint DEFAULT 1 NOT NULL,
...
CREATE TABLE tsf_dst_arg (
       nodeid               integer NOT NULL,
       tsf_arg_id           integer NOT NULL,
       tsf_dst_id           smallint NOT NULL,
       tsf_arg_name         varchar(32) NOT NULL,
       tsf_arg_value        varchar(64),
       PRIMARY KEY (nodeid, tsf_arg_id),
