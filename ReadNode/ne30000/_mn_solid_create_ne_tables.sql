...
CREATE TABLE agcf_global (
       ...
       pani_hndl            tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid)
);
...
CREATE TABLE feature_subs_set (
       ...
       feature_set_name     char(25) NOT NULL,
       ...
       max_prec_level       smallint DEFAULT 100 NOT NULL,
       ...
       conloss_auth         tinyint DEFAULT 0 NOT NULL,
       rdnc_auth            tinyint DEFAULT 0 NOT NULL,
       subs_status1         integer DEFAULT 0 NOT NULL,
...
CREATE TABLE subscriber (
       ...
       prng_group_id        smallint NOT NULL,
       ...
       fa_group_id          smallint DEFAULT 0 NOT NULL,
...
CREATE TABLE dsp_ip_feature (
       ...
       time_dtct_silence    smallint DEFAULT 200 NOT NULL,
...
CREATE TABLE gsmr_uui_coding (
       nodeid               integer NOT NULL,
       gsmr_uui_coding_var  tinyint NOT NULL,
       gsmr_fn_mode         tinyint DEFAULT 1 NOT NULL,
       gsmr_text_present    tinyint DEFAULT 1 NOT NULL,
       gsmr_acc_fn          varchar(25) DEFAULT NULL,
       gsmr_send_lct        tinyint DEFAULT 1 NOT NULL,
       gsmr_uui_param1      integer DEFAULT 0 NOT NULL,
       gsmr_uui_param2      integer DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, gsmr_uui_coding_var)
);
...
CREATE TABLE trunk_group (
       ...
       max_prec_level       smallint DEFAULT 100 NOT NULL,
       mlpp_id              smallint DEFAULT 0 NOT NULL,
       trnkgrp_nonpreempt   tinyint DEFAULT 0 NOT NULL,
       req_prec_level_conv  tinyint DEFAULT 0 NOT NULL,
       ...
       gsmr_uui_coding_var  tinyint DEFAULT 0 NOT NULL,
       nplan_usage          tinyint DEFAULT 0 NOT NULL,
       ib_info_manip        smallint DEFAULT 0 NOT NULL,
       cbact_auth           tinyint DEFAULT 0 NOT NULL,
       ...
       FOREIGN KEY (nodeid, ann_variant)
                             REFERENCES ann_variants,
       FOREIGN KEY (nodeid, gsmr_uui_coding_var)
                             REFERENCES gsmr_uui_coding
);
...
CREATE TABLE init_linesig (
       ...
       ad_convert_type      smallint DEFAULT 0 NOT NULL,
...
CREATE TABLE ctx_member (
       ...
       ibc_crosspath        tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE mn_trunk_group (
       ...
       trnkgrp_usage        tinyint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, trnkgrpid)
);
...
CREATE INDEX IE2_monitor_orders ON monitor_orders
(
	nodeid                ASC,
	monitored_present     ASC
);
...
CREATE TABLE global_timer (
       ...
       tm_lengthdep         smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid)
);
...
CREATE TABLE node (
       ...
       max_nr_ss7           smallint DEFAULT 16 NOT NULL,
       max_nr_hdlc          smallint DEFAULT 32 NOT NULL,
       max_nr_cas           smallint DEFAULT 32 NOT NULL,
       ...
       max_mon_user         integer DEFAULT 0 NOT NULL,
       ...
       sac_ringtone_dur     smallint NOT NULL,
       shelf_man_comm       char(16) DEFAULT 'private' NOT NULL,
       shelf_man_comm2      char(16) DEFAULT 'private' NOT NULL,
       shelf_man_ip_addr    char(15) DEFAULT '0.0.0.0' NOT NULL,
       shelf_man_ip_addr2   char(15) DEFAULT '0.0.0.0' NOT NULL,
       ...
       mlpp_standard        tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE ims_global (
       ...
       survive_mode         tinyint DEFAULT 0 NOT NULL,
       spec_func            smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid)
);
...
CREATE TABLE h248_interface (
       ...
       h248_intf_id         smallint DEFAULT 0 NOT NULL,
       intf_func            smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, sys_intf_id, h248_side),
       FOREIGN KEY (nodeid, h248_intf_prf_id)
                             REFERENCES h248_intf_profile,
...
CREATE TABLE isup_param (
       ...
       spec_net_mode        tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE ext_user_barrclass (
       ...
       PRIMARY KEY (nodeid, cbact_list_id, trnkgrpid, cgpn_prefix)
);
...
CREATE TABLE mgcp_interface (
       ...
       mgcp_intf_prf_id     smallint NOT NULL,
       sigtrace_req         smallint NOT NULL,
       mgcp_intf_id         integer DEFAULT 0 NOT NULL,
       intf_func            smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, sys_intf_id, mgcp_side),
       FOREIGN KEY (nodeid, mgcp_intf_prf_id)
                             REFERENCES mgcp_intf_profile
);
...
CREATE TABLE sctp_instance (
       ...
       sctp_prf_id          smallint NOT NULL,
       sctp_role            tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE global_tariff_data (
       ...
       olcdr_dataset        tinyint DEFAULT 0 NOT NULL,
       useragent_incdr      tinyint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, dummy_pk)
);
...
CREATE TABLE ms_feature (
       ...
       ms_module_enable     tinyint DEFAULT 1 NOT NULL,
       max_cnf_ptcp         smallint DEFAULT 160,
       cnf_srv_level        tinyint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, modulenr),
...
CREATE TABLE mad (
       ...
       nomadic_zone         tinyint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, mad_id)
);
...
CREATE TABLE msisdn (
       nodeid               integer NOT NULL,
       msisdn_mask          char(25) NOT NULL,
       plmn_id              tinyint NOT NULL,
       plmn_area            tinyint NOT NULL,
       PRIMARY KEY (nodeid, msisdn_mask)
);
...
CREATE TABLE map_dest_addr (
       nodeid               integer NOT NULL,
       map_dest_id          smallint NOT NULL,
       plmn_area            tinyint NOT NULL,
       dest_addr_rtng_ind   tinyint DEFAULT 0 NOT NULL,
       dest_addr_gt_ind     tinyint DEFAULT 4 NOT NULL,
       dest_addr_ssn_ind    tinyint DEFAULT 1 NOT NULL,
       ...
       dest_addr_np         tinyint DEFAULT 1 NOT NULL,
       dest_addr_es         tinyint DEFAULT 0 NOT NULL,
       dest_addr_nadi       smallint DEFAULT 2 NOT NULL,
       dest_addr_type       tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid, map_dest_id, plmn_area)
);
...
CREATE TABLE map_orig_addr (
       nodeid               integer NOT NULL,
       map_orig_id          smallint NOT NULL,
       ...
       orig_addr_es         tinyint DEFAULT 0 NOT NULL,
       orig_addr_nadi       smallint DEFAULT 2 NOT NULL,
       orig_addr_type       tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid, map_orig_id)
);
...
CREATE TABLE map_operation (
       ...
       map_tm_med           tinyint DEFAULT 30 NOT NULL,
       ...
       map_dest_id          smallint NOT NULL,
       map_orig_id          smallint NOT NULL,
       PRIMARY KEY (nodeid, map_op_id, plmn_id),
       FOREIGN KEY (nodeid, map_cpb_set_id)
                             REFERENCES map_ati,
       FOREIGN KEY (nodeid, map_orig_id)
                             REFERENCES map_orig_addr
);
...
CREATE TABLE map_appl_cntx (
       ...
       appl_cntx_ver        smallint NOT NULL,
       appl_cntx_name       smallint NOT NULL,
       appl_cntx_code       smallint NOT NULL,
       PRIMARY KEY (nodeid, map_op_code, appl_cntx_ver)
);
...
CREATE TABLE otc_monitoring (
       nodeid               integer NOT NULL,
       otc_dspt_circnr      char(2) NOT NULL,
       otc_monitdn          varchar(25) NOT NULL,
       tm_frame             tinyint DEFAULT 2 NOT NULL,
       PRIMARY KEY (nodeid, otc_dspt_circnr, otc_monitdn)
);
...
CREATE TABLE global_setup (
       nodeid               integer NOT NULL,
       uham_bereconn        smallint DEFAULT 210 NOT NULL,
       uham_beconfig        smallint DEFAULT 240 NOT NULL,
       PRIMARY KEY (nodeid)
);



CREATE TABLE pia_pba_setup (
       nodeid               integer NOT NULL,
       pba_setup_id         smallint NOT NULL,
       ring_frequency       smallint DEFAULT 25 NOT NULL,
       ring_voltage         smallint DEFAULT 80 NOT NULL,
       ring_bus             smallint DEFAULT 3 NOT NULL,
       PRIMARY KEY (nodeid, pba_setup_id)
);
...
CREATE TABLE board (
       ...
       shelfnr              smallint DEFAULT NULL,
       pba_setup_id         smallint DEFAULT NULL,
       main_board_dsc       char(32) DEFAULT NULL,
       PRIMARY KEY (nodeid, boardnr),
       FOREIGN KEY (nodeid, pba_setup_id)
                             REFERENCES pia_pba_setup
		ON DELETE SET NULL
		ON UPDATE SET NULL
);
...
CREATE TABLE e1_profile (
       ...
       default_data         smallint DEFAULT 0 NOT NULL,
...
CREATE TABLE pia_taj_port_profile (
       nodeid               integer NOT NULL,
       taj_portprofile_id   smallint NOT NULL,
       audio_direction      smallint NOT NULL,
       wdt_usage            smallint NOT NULL,
       out_level1           float NOT NULL,
       out_level2           float NOT NULL,
       in_level1            float DEFAULT 0 NOT NULL,
       in_level2            float DEFAULT 0 NOT NULL,
       default_data         smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, taj_portprofile_id)
);



CREATE TABLE pia_taj_port (
       nodeid               integer NOT NULL,
       portnr               smallint NOT NULL,
       taj_portprofile_id   smallint NOT NULL,
       PRIMARY KEY (nodeid, portnr),
       FOREIGN KEY (nodeid, taj_portprofile_id)
                             REFERENCES pia_taj_port_profile
);
...
CREATE UNIQUE INDEX AK1_h323_acc_profile ON h323_acc_profile
(
	nodeid                ASC,
	profile_name          ASC
);
...
CREATE TABLE otc_duty_profile (
       ...
       otc_tdm_rtp_id       smallint DEFAULT '-1' NOT NULL,
       init_conn_state      tinyint DEFAULT 0 NOT NULL,
       tm_limit_conn        smallint DEFAULT 0 NOT NULL,
...
CREATE TABLE pia_tac_port_profile (
       nodeid               integer NOT NULL,
       tac_portprofile_id   smallint NOT NULL,
       aport_func           smallint NOT NULL,
       impedance            smallint NOT NULL,
       in_gain              float,
       out_gain             float,
       equalizer_type       smallint NOT NULL,
       default_data         smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, tac_portprofile_id)
);



CREATE TABLE pia_tac_port (
       nodeid               integer NOT NULL,
       portnr               smallint NOT NULL,
       tac_portprofile_id   smallint NOT NULL,
       PRIMARY KEY (nodeid, portnr),
       FOREIGN KEY (nodeid, tac_portprofile_id)
                             REFERENCES pia_tac_port_profile
);
...
CREATE TABLE voip_dsp_cfg (
       nodeid               integer NOT NULL,
       board_pos            smallint NOT NULL,
       wbtdm_dsp_count      tinyint NOT NULL,
       PRIMARY KEY (nodeid, board_pos)
);



CREATE TABLE pia_aport_profile (
       nodeid               integer NOT NULL,
       aport_profile_id     smallint NOT NULL,
       profile_name         char(50) NOT NULL,
       port_event_limit     integer DEFAULT 150 NOT NULL,
       aport_connection_type integer DEFAULT 0 NOT NULL,
       default_data         smallint DEFAULT 0 NOT NULL,
       aport_control_mapping integer DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, aport_profile_id)
);
...
CREATE TABLE dhcp_subnet (
       nodeid               integer NOT NULL,
       dhcp_subnet_id       tinyint NOT NULL,
       subnet_comment       char(40) DEFAULT 'no comment' NOT NULL,
       subnet_addr          char(15) DEFAULT '0.0.0.0' NOT NULL,
       subnet_mask          char(15) DEFAULT '255.255.255.0' NOT NULL,
       lease_time           char(10) DEFAULT '3600' NOT NULL,
       dflt_router          char(15) DEFAULT '0.0.0.0' NOT NULL,
       tftp_server_name     char(64) DEFAULT 'config.acme.com' NOT NULL,
       tftp_file_name       char(128) DEFAULT 'sipType1.cfg' NOT NULL,
       tftp_domain_name     char(255) DEFAULT 'www.acme.com' NOT NULL,
       primary_dns          char(15) DEFAULT '0.0.0.0' NOT NULL,
       secondary_dns        char(15) DEFAULT '0.0.0.0' NOT NULL,
       authoritative_srv    tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid, dhcp_subnet_id)
);



CREATE SEQUENCE seq_dhcp_subnet_id;



CREATE TABLE dhcp_host (
       nodeid               integer NOT NULL,
       dhcp_host_id         tinyint NOT NULL,
       host_comment         char(40) DEFAULT 'no comment' NOT NULL,
       host_name            char(20) DEFAULT 'hostname' NOT NULL,
       eth_mac_addr         char(17) DEFAULT '00:00:00:00:00:00' NOT NULL,
       static_ip_addr       char(15) DEFAULT '0.0.0.0' NOT NULL,
       tftp_server_name     char(64) DEFAULT 'config.acme.com' NOT NULL,
       tftp_file_name       char(128) DEFAULT 'sipType1.cfg' NOT NULL,
       dhcp_subnet_id       tinyint NOT NULL,
       PRIMARY KEY (nodeid, dhcp_host_id),
       FOREIGN KEY (nodeid, dhcp_subnet_id)
                             REFERENCES dhcp_subnet
		ON DELETE CASCADE
		ON UPDATE CASCADE
);
...
CREATE SEQUENCE seq_dhcp_host_id;



CREATE TABLE dhcp_class (
       nodeid               integer NOT NULL,
       dhcp_class_id        tinyint NOT NULL,
       class_comment        char(40) DEFAULT 'no comment' NOT NULL,
       class_name           char(20) DEFAULT 'name' NOT NULL,
       class_match          char(80) DEFAULT 'if (option.vendor-class-identifier = "sip_type_1"' NOT NULL,
       PRIMARY KEY (nodeid, dhcp_class_id)
);



CREATE UNIQUE INDEX AK1_dhcp_class ON dhcp_class
(
	nodeid                ASC,
	class_name            ASC
);
...
CREATE SEQUENCE seq_dhcp_class_id;



CREATE TABLE dhcp_pool (
       nodeid               integer NOT NULL,
       dhcp_pool_id         tinyint NOT NULL,
       pool_comment         char(40) DEFAULT 'no comment' NOT NULL,
       low_ip_range         char(15) DEFAULT '0.0.0.0' NOT NULL,
       high_ip_range        char(15) DEFAULT '0.0.0.0' NOT NULL,
       low_bckp_ip_range    char(15) DEFAULT '0.0.0.0' NOT NULL,
       high_bckp_ip_range   char(15) DEFAULT '0.0.0.0' NOT NULL,
       tftp_server_name     char(64) DEFAULT 'config.acme.com' NOT NULL,
       tftp_file_name       char(128) DEFAULT 'sipType1.cfg' NOT NULL,
       dhcp_class_id        tinyint NOT NULL,
       dhcp_subnet_id       tinyint NOT NULL,
       PRIMARY KEY (nodeid, dhcp_pool_id),
       FOREIGN KEY (nodeid, dhcp_class_id)
                             REFERENCES dhcp_class
		ON DELETE CASCADE
		ON UPDATE CASCADE,
       FOREIGN KEY (nodeid, dhcp_subnet_id)
                             REFERENCES dhcp_subnet
...
CREATE SEQUENCE seq_dhcp_pool_id;
...
CREATE TABLE pia_stbus (
       nodeid               integer NOT NULL,
       portnr               smallint NOT NULL,
       ci                   smallint NOT NULL,
       stbus_id             smallint NOT NULL,
       stbus_ci             smallint NOT NULL,
       PRIMARY KEY (nodeid, portnr, ci)
);
...
CREATE TABLE ioc_loop_list (
       ...
       PRIMARY KEY (nodeid, ioc_loop_list_id, ioc_loop_party, ioc_loop_partynr)
);
...
CREATE TABLE dhcp_relay (
       nodeid               integer NOT NULL,
       dummy_pk             smallint NOT NULL,
       dhcp_srvr_ip_addr1   char(15) DEFAULT NULL,
       dhcp_srvr_ip_addr2   char(15) DEFAULT NULL,
       dhcp_srvr_ip_addr3   char(15) DEFAULT NULL,
       dhcp_relay_enbl      tinyint DEFAULT 0 NOT NULL,
       shelf_id             char(39) NOT NULL,
       PRIMARY KEY (nodeid, dummy_pk)
);
...
CREATE TABLE pfx_len_depend (
       nodeid               integer NOT NULL,
       ndc_id               smallint NOT NULL,
       in_dstid             smallint NOT NULL,
       nr_length            tinyint NOT NULL,
       cid                  smallint NOT NULL,
       nplan_id             smallint NOT NULL,
       dstctg               smallint DEFAULT 1 NOT NULL,
       dstid                smallint DEFAULT 0 NOT NULL,
       dst_charge_code      smallint DEFAULT '-2' NOT NULL,
       stat_group_id        smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, ndc_id, in_dstid, nr_length, cid, nplan_id)
);
...
CREATE TABLE eth_interface (
       nodeid               integer NOT NULL,
       eth_intf_id          smallint NOT NULL,
       eth_intf_name        char(50) NOT NULL,
       modulenr             smallint NOT NULL,
       portnr               smallint NOT NULL,
       oosi                 smallint NOT NULL,
...
CREATE TABLE sync (
       nodeid               integer NOT NULL,
       board_pos            smallint NOT NULL,
       source_num           tinyint NOT NULL,
       source_type          tinyint DEFAULT 1 NOT NULL,
       source_id            tinyint DEFAULT 1 NOT NULL,
       destination_type     tinyint DEFAULT 0 NOT NULL,
       destination_id       tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid, board_pos, source_num)
);
...
CREATE TABLE ntp_config (
       ...
       dst_start_week       smallint DEFAULT 5 NOT NULL,
       dst_start_wday       smallint DEFAULT 0 NOT NULL,
       dst_start_hour       smallint DEFAULT 1 NOT NULL,
       dst_start_min        smallint DEFAULT 0 NOT NULL,
       dst_end_mon          smallint DEFAULT 10 NOT NULL,
       dst_end_week         smallint DEFAULT 5 NOT NULL,
       dst_end_wday         smallint DEFAULT 0 NOT NULL,
       dst_end_hour         smallint DEFAULT 1 NOT NULL,
...
CREATE TABLE otc_node (
       ...
       rem_prefix           char(10),
       rem_nodeid           integer DEFAULT NULL,
...
CREATE TABLE otc_dspt_circ (
       ...
       bypass_trunk         smallint DEFAULT NULL,
       otc_redundancy_type  tinyint DEFAULT 0 NOT NULL,
       otc_redundancy_nodeid smallint DEFAULT NULL,
...
CREATE TABLE otc_duty (
       ...
       otc_alt_ana_duty     varchar(3) DEFAULT NULL,
       auto_dial            tinyint DEFAULT 0 NOT NULL,
       extern_arm_testing   tinyint DEFAULT 0 NOT NULL,
       otc_redundant_check  tinyint DEFAULT 0 NOT NULL,
...
CREATE TABLE common_srv_setting (
       ...
       linkage_cw           tinyint DEFAULT 0 NOT NULL,
       nplan_usage          tinyint DEFAULT 0 NOT NULL,
       ip_geo_rstr_status   tinyint DEFAULT 0 NOT NULL,
       ip_geo_rstr_type     tinyint DEFAULT 0 NOT NULL,
       peoc_dest_mode       tinyint DEFAULT 0 NOT NULL,
       cbact_mode           tinyint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid)
);
...
CREATE TABLE sip_access (
       ...
       password_type        tinyint DEFAULT 0 NOT NULL,
       password_encrypt     varchar(96) DEFAULT '' NOT NULL,
       tgrp                 varchar(10) DEFAULT '' NOT NULL,
       default_acc          tinyint DEFAULT 0 NOT NULL,
       rcs_enabled          tinyint DEFAULT 1 NOT NULL,
       sip_sec_subs_alias   varchar(25) DEFAULT '' NOT NULL,
       PRIMARY KEY (nodeid, modulenr, portnr),
       FOREIGN KEY (nodeid, sip_feature_id)
                             REFERENCES sip_feature,
       FOREIGN KEY (nodeid, modulenr, portnr)
...
CREATE INDEX IE5_sip_access ON sip_access
(
	nodeid                ASC,
	tgrp                  ASC,
	reg_mode              ASC
...
CREATE INDEX IE6_sip_access ON sip_access
(
	nodeid                ASC,
	tgrp                  ASC,
	default_acc           ASC
...
CREATE TABLE pia_ad_convert (
       nodeid               integer NOT NULL,
       ad_convert_type      smallint NOT NULL,
       ad_instate           smallint NOT NULL,
       ad_conv_direction    smallint NOT NULL,
       set_ad_outstate      smallint NOT NULL,
       reset_ad_outstate    smallint NOT NULL,
...
CREATE TABLE conloss_control (
       nodeid               integer NOT NULL,
       dn                   integer NOT NULL,
       dstdn1               varchar(25) NOT NULL,
       dstdn2               varchar(25) NOT NULL,
       PRIMARY KEY (nodeid, dn)
);
...
CREATE TABLE sbk_port_profile (
       nodeid               integer NOT NULL,
       port_profile_id      smallint NOT NULL,
       profile_name         char(50) NOT NULL,
       default_data         smallint NOT NULL,
       PRIMARY KEY (nodeid, port_profile_id)
);



CREATE UNIQUE INDEX AK1_sbk_port_profile ON sbk_port_profile
(
	nodeid                ASC,
	profile_name          ASC
);
...
CREATE TABLE pia_tae_port_profile (
       nodeid               integer NOT NULL,
       tae_portprofile_id   smallint NOT NULL,
       board_variant        tinyint DEFAULT 0 NOT NULL,
       line_imp_real_complex tinyint DEFAULT 0 NOT NULL,
       line_imp_real        smallint DEFAULT 600 NOT NULL,
       line_imp_complex     tinyint DEFAULT 4 NOT NULL,
       line_imp_n           tinyint DEFAULT 1 NOT NULL,
       in_out_imp_high_low  tinyint DEFAULT 1 NOT NULL,
       imp_rs               smallint DEFAULT 100 NOT NULL,
       imp_rp               smallint DEFAULT 200 NOT NULL,
       imp_cp               smallint DEFAULT 50 NOT NULL,
       input_relative_level float DEFAULT 0 NOT NULL,
       output_relative_level float DEFAULT 0 NOT NULL,
       equalizer_type       smallint DEFAULT 0 NOT NULL,
       default_data         smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, tae_portprofile_id)
);



CREATE TABLE pia_tae_port (
       nodeid               integer NOT NULL,
       portnr               smallint NOT NULL,
       tae_portprofile_id   smallint NOT NULL,
       PRIMARY KEY (nodeid, portnr),
       FOREIGN KEY (nodeid, tae_portprofile_id)
                             REFERENCES pia_tae_port_profile
);
...
CREATE TABLE dsp_opt_by_func (
       nodeid               integer NOT NULL,
       dsp_opt_func_id      smallint NOT NULL,
       dsp_opt_func_name    varchar(50) NOT NULL,
       vad_threshold        tinyint DEFAULT '-24' NOT NULL,
       time_dtct_silence    smallint NOT NULL,
       time_dtct_talk       smallint DEFAULT 0 NOT NULL,
       dsp_opt_reserve1     smallint DEFAULT 0 NOT NULL,
       dsp_opt_reserve2     smallint DEFAULT 0 NOT NULL,
       dsp_opt_reserve3     smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, dsp_opt_func_id)
);



CREATE UNIQUE INDEX AK1_dsp_opt_by_func ON dsp_opt_by_func
(
	nodeid                ASC,
	dsp_opt_func_name     ASC
);



CREATE TABLE rdnc_call (
       nodeid               integer NOT NULL,
       dn                   integer NOT NULL,
       rdnc_prio            tinyint NOT NULL,
       dstdn                char(25) NOT NULL,
       PRIMARY KEY (nodeid, dn, rdnc_prio)
);
...
CREATE TABLE trans_precedence (
       nodeid               integer NOT NULL,
       called_prec_level    tinyint DEFAULT 100 NOT NULL,
       trans_prec_level     smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, called_prec_level)
);
...
CREATE TABLE shelf (
       nodeid               integer NOT NULL,
       shelfnr              smallint NOT NULL,
       shelf_name           char(32) NOT NULL,
       shelf_id             char(39),
       shelf_type           char(30) NOT NULL,
       container_id         integer,
       PRIMARY KEY (nodeid, shelfnr)
);



CREATE UNIQUE INDEX AK1_shelf ON shelf
(
	nodeid                ASC,
	shelf_name            ASC
);
...
CREATE TABLE ip_geo_rstr_group (
       nodeid               integer NOT NULL,
       ip_geo_group_id      integer NOT NULL,
       ip_geo_rstr_mode     tinyint DEFAULT 1 NOT NULL,
       ip_geo_rstr_name     varchar(30) NOT NULL,
       PRIMARY KEY (nodeid, ip_geo_group_id)
);



CREATE UNIQUE INDEX AK1_ip_geo_rstr_group ON ip_geo_rstr_group
(
	nodeid                ASC,
	ip_geo_rstr_name      ASC
);
...
CREATE TABLE otc_trunk_profile (
       ...
       perm_conn            tinyint DEFAULT 0 NOT NULL,
       perm_conn_retry_tm   smallint DEFAULT 60 NOT NULL,
       tm_reconn            smallint DEFAULT 50 NOT NULL,
       tm_limit_conn        smallint DEFAULT 0 NOT NULL,
       tm_minreconn         smallint DEFAULT 35 NOT NULL,
...
CREATE TABLE sak_port_profile (
       nodeid               integer NOT NULL,
       port_profile_id      smallint NOT NULL,
       port_profile_name    char(20) NOT NULL,
       filter_width         integer DEFAULT 15,
       on_hook              integer DEFAULT 350,
       off_hook             integer DEFAULT 150,
       break_min            integer DEFAULT 30,
       break_max            integer DEFAULT 80,
       min2                 smallint DEFAULT 30,
       mid1                 smallint,
       max2                 smallint DEFAULT 80,
       flash_min            integer DEFAULT 85,
       flash_max            integer DEFAULT 200,
       interdigit           integer DEFAULT 160,
       alerting             integer DEFAULT 0,
       ring_pulse           integer DEFAULT 200,
       dual_tone            integer DEFAULT 100,
       t2_afterfsk_trans    smallint DEFAULT 200,
       t3_pre_fsk_trans     smallint DEFAULT 500,
       t4_pre_fsk_trans     smallint DEFAULT 150,
       t5_pre_fsk_trans     smallint DEFAULT 600,
       t6_afterfsk_trans    smallint DEFAULT 300,
       duslic_coefficient   integer DEFAULT 0,
       hook_flash           integer DEFAULT 90,
       fsk_mode             integer DEFAULT 0,
       transmition          integer DEFAULT 0,
       transmition_method   integer DEFAULT 0,
       ring_signal          smallint,
       chargeintmask        smallint,
       line_current         smallint,
       rings_frequency      smallint,
       tariff_frequency     smallint,
       tariff_sig_level     double precision,
       impedance            smallint NOT NULL,
       burst_length         smallint DEFAULT 140,
       port_profile_bits    integer,
       default_data         smallint NOT NULL,
       dtmf_mode            smallint DEFAULT 0,
       dynamic_rtp_rx       integer DEFAULT 101,
       dynamic_rtp_tx       integer DEFAULT 101,
       repetitions_nr       integer DEFAULT 1,
       ring_signal_format   smallint DEFAULT 0 NOT NULL,
       as_clip_variant      smallint NOT NULL,
       aon_variant          smallint NOT NULL,
       aon_ind_wait         integer DEFAULT 1 NOT NULL,
       aon_data_send        integer DEFAULT 1 NOT NULL,
       aon_add_nr           integer DEFAULT 2 NOT NULL,
       aon_pulse_length     integer DEFAULT 40 NOT NULL,
       aon_info_delay       integer DEFAULT 250 NOT NULL,
       aon_min_duration     integer DEFAULT 90 NOT NULL,
       aon_delay_info       integer DEFAULT 50 NOT NULL,
       aon_wait             integer DEFAULT 700 NOT NULL,
       aon_adapter          smallint DEFAULT 0 NOT NULL,
       hook_line_current    smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, port_profile_id)
);



CREATE UNIQUE INDEX AK1_sak_port_profile ON sak_port_profile
(
	nodeid                ASC,
	port_profile_name     ASC
);



CREATE TABLE sak_audio_profile (
       nodeid               integer NOT NULL,
       audio_profile_id     smallint NOT NULL,
       audio_profile_name   char(20) NOT NULL,
       packet_loss          tinyint DEFAULT 1 NOT NULL,
       vad_threshold        tinyint DEFAULT '-40' NOT NULL,
       idle_noise_level     tinyint DEFAULT '-60' NOT NULL,
       change_ssrc          tinyint DEFAULT 0 NOT NULL,
       default_profile      tinyint NOT NULL,
       PRIMARY KEY (nodeid, audio_profile_id)
);



CREATE UNIQUE INDEX AK1_sak_audio_profile ON sak_audio_profile
(
	nodeid                ASC,
	audio_profile_name    ASC
);
...
CREATE TABLE la_board (
       nodeid               integer NOT NULL,
       boardnr              smallint NOT NULL,
       telnet_password      char(33) NOT NULL,
       ne_release           char(32) NOT NULL,
       eth_port1_equip      tinyint NOT NULL,
       eth_port2_equip      tinyint NOT NULL,
       audio_profile_id     smallint,
       dsp_ip_feature_id    smallint,
       test_type            smallint DEFAULT NULL,
       container_id         integer DEFAULT NULL,
       PRIMARY KEY (nodeid, boardnr),
       FOREIGN KEY (nodeid, audio_profile_id)
                             REFERENCES sak_audio_profile,
       FOREIGN KEY (nodeid, dsp_ip_feature_id)
                             REFERENCES dsp_ip_feature
);
...
CREATE TABLE pia_taf_port_profile (
       nodeid               integer NOT NULL,
       taf_portprofile_id   smallint NOT NULL,
       ring_frequency       smallint DEFAULT 25 NOT NULL,
       impedance            smallint DEFAULT 2 NOT NULL,
       in_out_gain          tinyint DEFAULT 0 NOT NULL,
       default_data         smallint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, taf_portprofile_id)
);



CREATE TABLE pia_taf_port (
       nodeid               integer NOT NULL,
       portnr               smallint NOT NULL,
       taf_portprofile_id   smallint NOT NULL,
       PRIMARY KEY (nodeid, portnr),
       FOREIGN KEY (nodeid, taf_portprofile_id)
                             REFERENCES pia_taf_port_profile
);
...
CREATE TABLE ip_geo_rstr_range (
       nodeid               integer NOT NULL,
       ip_geo_group_id      integer NOT NULL,
       ip_geo_range_id      smallint NOT NULL,
       start_rng_ip_addr    varchar(15) DEFAULT '0.0.0.0' NOT NULL,
       start_rng_ip_number  bigint DEFAULT 0 NOT NULL,
       end_rng_ip_addr      varchar(15) DEFAULT '0.0.0.0' NOT NULL,
       end_rng_ip_number    bigint DEFAULT 0 NOT NULL,
       PRIMARY KEY (nodeid, ip_geo_group_id, ip_geo_range_id)
);



CREATE TABLE t_monitor_orders (
       nodeid               integer NOT NULL,
       monitored_trunk      varchar(25) NOT NULL,
       monitoring_nr        char(25) NOT NULL,
       monitored_present    char(25) NOT NULL,
       monitored_loc        smallint NOT NULL,
       monitoring_loc       smallint NOT NULL,
       ming_term_type       smallint NOT NULL,
       protocol             smallint NOT NULL,
       monitoring_module    smallint NOT NULL,
       monitoring_port      smallint NOT NULL,
       PRIMARY KEY (nodeid, monitored_trunk, monitoring_nr)
);



CREATE INDEX IE1_t_monitor_orders ON t_monitor_orders
(
	nodeid                ASC,
	monitored_present     ASC
);
...
CREATE TABLE rdnc_feature (
       nodeid               integer NOT NULL,
       dn                   integer NOT NULL,
       rdnc_tout_next_try   smallint DEFAULT 1000 NOT NULL,
       rdnc_max_try_count   tinyint DEFAULT 1 NOT NULL,
       rdnc_max_call_time   integer DEFAULT 600 NOT NULL,
       rdnc_endless_call    tinyint DEFAULT 1 NOT NULL,
       PRIMARY KEY (nodeid, dn)
);
...
CREATE TABLE mn_numbering_plan (
       nodeid               integer NOT NULL,
       nplan_id             smallint DEFAULT 1 NOT NULL,
       nplan_name           varchar(30) NOT NULL,
       PRIMARY KEY (nodeid, nplan_id)
);



CREATE UNIQUE INDEX AK1_mn_numbering_plan ON mn_numbering_plan
(
	nodeid                ASC,
	nplan_name            ASC
);
...
CREATE TABLE prepaid_subs_set (
       ...
       report_empty         tinyint DEFAULT 0 NOT NULL,
